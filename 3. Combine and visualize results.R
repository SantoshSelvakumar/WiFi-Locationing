###############################################################################
#                                                                             #
#   WIFI | CREATE TIBBLE/DATAFRAME WITH RESULTS | FINAL VERSION               #
#                                                                             #
...
resultsFLOOR <- readRDS(file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsFLOOR(V7).rds")
resultsBUILDING <- readRDS(file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsBUILDING(V7).rds")
resultsLATITUDE <- readRDS(file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsLATITUDE(V7).rds")
resultsLONGITUDE <- readRDS(file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsLONGITUDE(V7).rds")
...
resultsVSactual <- readRDS(file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsVSactual(3).rds")
