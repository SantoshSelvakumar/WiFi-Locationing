###############################################################################
#                                                                             #
#   WIFI | TRAINING SVM MODEL ONE FOR FLOOR | FINAL VERSION                   #
#                                                                             #
...
indexTrain <- createDataPartition(trainingData$FLOOR, p = .05, list = FALSE)
...
wrongFLOOR[,465:475]
saveRDS(wrongFLOOR, file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/errorsFLOOR-training.rds")
...
write.csv(wrongFLOORVal, file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/errorsfloorbuilding1.csv")
...
saveRDS(wrongFLOOR, file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/errorsFLOOR-validation.rds")
...
# store as RDS
saveRDS(resultsFLOOR, file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsFLOOR(V7).rds")
