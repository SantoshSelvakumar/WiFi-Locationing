###############################################################################
#                                                                             #
#   WIFI | TRAINING SVM FOR BUILDINGID | VERSION 7.0                          #
#                                                                             #
...
indexTrain <- createDataPartition(trainingData$BUILDINGID, p = .05, list = FALSE)
...
# store as RDS
saveRDS(resultsBUILDING, file = "C:/Users/Santosh/Desktop/Ubiqum/RStudio/WIFI_Locationing_2/resultsBUILDING(V7).rds")
